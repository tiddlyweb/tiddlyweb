...
def test_get_bags_filters():
    response, content = http.requestU('http://our_test_domain:8001/bags?select=name:bag1',
            headers={'Accept': 'text/plain'},
            method='GET')
...
def test_get_bags_filters():
    response, content = http.requestU('http://our_test_domain:8001/bags?select=rbag:figgy',
            headers={'Accept': 'text/plain'},
            method='GET')
...
def test_get_bags_selected_sorted_filters():
    response, content = http.requestU('http://our_test_domain:8001/bags?select=name:>bag2',
            headers={'Accept': 'text/plain'},
            method='GET')
...
def test_get_bags_sorted_filters():
    response, content = http.requestU('http://our_test_domain:8001/bags?sort=-name',
            headers={'Accept': 'text/plain'},
            method='GET')
...
def test_get_bags_sorted_limitedfilters():
    response, content = http.requestU('http://our_test_domain:8001/bags?sort=-name;limit=1,1',
            headers={'Accept': 'text/plain'},
            method='GET')
