"""
This is the handler code for running TiddlyWeb via apache using
mod_wsgi, mod_python or Passenger.

It is called by apache.py, which will be located in the instance
directory. All that file does is call this file.

mod_wsgi is considered the best choice.
...
In WSGIScriptAlias you may use just / for the path, but this
you will need to set Alias directives in the Apache config
for hosting other things on the same VirtualHost.
